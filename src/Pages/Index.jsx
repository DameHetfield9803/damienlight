...
export default function Index() {
    return (
        <div
            className={"rounded-sm container bg-gradient-to-r from-sky-100 to-teal-200 min-w-full min-h-screen py-2 subpixel-antialiased"}>
            <nav className={"min-w-fit mb-2 mx-auto mt-3"}>
                <div className={"container max-w-screen mx-auto"}>
                    <ul className={"space-x-4 items-start inline-flex"}>
            ...
            <img src={es} alt={"Edusave Award 2019"} width={500} className={"flex mx-auto"}/>
        </div>
    )
}